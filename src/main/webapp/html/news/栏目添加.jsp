...
<center>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td height="30" valign="middle" background="../../images/bg_03.gif">
                            <div align="left"><font color="#FFFFFF">栏目添加</font></div>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <form name="form1" method="post" action="${pageContext.request.contextPath}/newslabel/addNewslabel">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
            ...
            <tr>
                ...
                <td width="86%" class="td_02">
                    <input name="labelName" type="text" class="input" style="width:99% ">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="td_02">
                    <textarea name="labelContent" rows="5" style="width:99% "></textarea>
                </td>
            </tr>
        </table>
        <br>
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td class="td_page">
                    <div align="center">
                        <input name="Submit" type="submit" class="buttonface02" value="  添 加  " onClick="return confirm('是否确定添加此栏目？')">
                        &nbsp;&nbsp;
