					  ...
					  <div id="menu_5" style="DISPLAY: none">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td nowrap><a href="${pageContext.request.contextPath}/newslabel/management" target="mainFrame" class="a03">栏目管理</a></td>
						  </tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="${pageContext.request.contextPath}/news/newsPage" target="mainFrame" class="a03">新闻发布</a></td>
						  </tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
							<td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
							<td nowrap><a href="${pageContext.request.contextPath}/news/selectMany?labelId=0" target="mainFrame" class="a03">新闻维护</a></td>
						  </tr>
						</table>
					  </div>
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
